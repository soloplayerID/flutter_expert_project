...
void main() {
  ...
  group('get Tv series detail', () {
    ...
    final tTvSeriesList = TvSeriesDetailModel.fromJson(
        json.decode(readJson('dummy_data/tv_series/tvseries_detail.json')));
    ...
    test('should return tv series detail when the response code is 200',
      ...
      when(mockHttpClient.get(Uri.parse('$BASE_URL/tv/$tId?$API_KEY')))
          .thenAnswer((_) async => http.Response(
              readJson('dummy_data/tv_series/tvseries_detail.json'), 200));
      // act
  ...
  group('get Tv series season detail', () {
    ...
    test('should return tv series season detail when the response code is 200',
      ...
      when(mockHttpClient.get(
          ...
          .thenAnswer((_) async =>
              http.Response(readJson('dummy_data/tv_series/season.json'), 200));
      // act
  ...
  group('get tv series recommendations', () {
    final tTvSeriesList = TvSeriesResponse.fromJson(json.decode(
            readJson('dummy_data/tv_series/tvseries_recommendations.json')))
        .tvseriesList;
    final tId = 1;
  ...
  group('search tv series', () {
    final tSearchResult = TvSeriesResponse.fromJson(json.decode(
            readJson('dummy_data/tv_series/search_moneyheist_tvseries.json')))
        .tvseriesList;
